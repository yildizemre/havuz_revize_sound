...
from deep_sort import preprocessing, nn_matching, track
...
def detection():
    ...
    global frame_num,fps_array,track
        ...
        for track in tracker.tracks:
            ...
            if(int((bbox[0]+bbox[2])/2)>600):
                if(int((bbox[1]+bbox[3])/2)>600):
                    ...
                    cv2.putText(frame, class_name + "-" + str(track.track_id)+"-"+str(int(float(time_label))),(int(bbox[0]), int(bbox[1]-10)),0, 0.75, (255,255,255),2)
...
def detection2(frame_sayisi):

    global frame_num,track
        ...
        if frame_num%frame_sayisi==0:
            ...
            if(int((bbox[0]+bbox[2])/2)>600):
                if(int((bbox[1]+bbox[3])/2)>600):
                    ...
                    cv2.putText(frame, class_name + "-" + str(track.track_id)+"-"+str(int(float(float(time_label)/float(frame_sayisi)))),(int(bbox[0]), int(bbox[1]-10)),0, 0.75, (255,255,255),2)
