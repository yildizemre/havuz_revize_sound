...
def main(_argv):
    ...
    while True:
        ...
        # draw bbox on screen
            ...
            cv2.putText(frame, class_name + "-" + str(track.track_id)+"-"+str(time_label),(int(bbox[0]), int(bbox[1]-10)),0, 0.75, (255,255,255),2)
        ...
        print("İşleme süresi",(time.time() - start_time))
        toplam_frame+=(time.time() - start_time)
        print("TOplam işleme süresi",toplam_frame)
        print("FPS: %.2f" % fps)
